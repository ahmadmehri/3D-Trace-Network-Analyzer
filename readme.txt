...
To run the analysis on your data, just so you know, for traces and points cloud with high accuracy, the algorithm will work very slowly! Then, it would be best for you to make your trace polylines and points cloud as simple as possible. The point cloud is only for surface referencing, so it could be a low-density points cloud.
...
https://www.youtube.com/watch?v=RjuBh4FURRk
